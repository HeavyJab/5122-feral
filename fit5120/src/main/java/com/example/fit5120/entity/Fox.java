...
public class Fox {
    ...
    @SequenceGenerator(
            name = "fox_sequence",
            sequenceName = "fox_sequence",
            allocationSize = 1
    )
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "fox_sequence"
    )
    ...
    public Fox(int id, String commonName, String scientificName, String taxonomyClass, String taxonomyFamily, String taxonomyGenus, String diet, String habitat, String appearance, String originPlace, String spread, String appearanceImage, String ecosystemIcon, String economicIcon, String socialIcon, String agricultureIcon, String prey, String behaviour, String ecosystemImpact, String economicImpact, String healthImpact, String agricultureImpact, String distribution) {
        this.id = id;
