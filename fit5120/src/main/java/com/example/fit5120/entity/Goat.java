...
public class Goat {
    ...
    @SequenceGenerator(
            name = "pig_sequence",
            sequenceName = "pig_sequence",
            allocationSize = 1
    )
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "pig_sequence"
    )
    ...
    public Goat(int id, String commonName, String scientificName, String taxonomyClass, String taxonomyFamily, String taxonomyGenus, String diet, String habits, String appearance, String originPlace, String spread, String appearanceImage, String ecosystemIcon, String economicIcon, String socialIcon, String agricultureIcon, String prey, String behaviour, String ecosystemImpact, String economicImpact, String healthImpact, String agricultureImpact, String distribution) {
        this.id = id;
